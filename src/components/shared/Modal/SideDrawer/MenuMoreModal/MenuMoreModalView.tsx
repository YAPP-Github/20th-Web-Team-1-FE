...
import * as S from './MenuMoreModal.styled';
import { MenuMoreModalViewPropsType } from './type';

const MenuMoreModalView = ({ setOnMenuMoreModal }: MenuMoreModalViewPropsType) => {
	return (
		<ModalPortal>
			<S.ModalWrapper>
				<ul>
...
export default MenuMoreModalView;
