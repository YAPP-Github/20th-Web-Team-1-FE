...
const EditFolderMoreModal = ({ modalPosition, onEditMoreModal, setOnEditMoreModal }: Props) => {
	return (
		<EditFolderMoreFrame onEditMoreModal={onEditMoreModal} setOnEditMoreModal={setOnEditMoreModal}>
